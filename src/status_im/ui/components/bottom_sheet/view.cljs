...
(defn animate-sign-panel
  ...
  (animate {:bottom   bottom-value, :new-bottom-value 0
            :opacity  opacity-value, :new-opacity-value 1
...
(defn- cancel
  ...
  ([{:keys [height bottom-value show-sheet? opacity-value]} callback]
   (animate {:bottom   bottom-value, :new-bottom-value height
             :opacity  opacity-value, :new-opacity-value 0
