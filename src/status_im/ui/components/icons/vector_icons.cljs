...
(def icons
  (if platform/desktop?
    {;; Main icons
     ...
     ;; Toolbar icons
     :toolbar-icons/home           (js/require "./resources/icons/toolbar/home.svg")
     :toolbar-icons/wallet         (js/require "./resources/icons/toolbar/wallet.svg")
     :toolbar-icons/profile        (js/require "./resources/icons/toolbar/profile.svg")
     ;; Old icons
     :icons/discover               (js/require "./resources/icons/discover.svg")
    ...
    {;; Main icons
     ...
     ;; Toolbar icons
     :toolbar-icons/home           (components.svg/slurp-svg "./resources/icons/toolbar/home.svg")
     :toolbar-icons/wallet         (components.svg/slurp-svg "./resources/icons/toolbar/wallet.svg")
     :toolbar-icons/profile        (components.svg/slurp-svg "./resources/icons/toolbar/profile.svg")
     ;; Old icons
     :icons/discover               (components.svg/slurp-svg "./resources/icons/discover.svg")
